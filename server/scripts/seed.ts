...
async function main() {
  ...
  // ── 1. Users (10 employers, 12 job seekers) ───────────────────
  await User.deleteMany({});

  const hash = (pw: string) => bcrypt.hash(pw, 12);

  const [shoaib, maria, alex, james, sarah, tom, emma, david, priya, lucas] =
    await Promise.all([
      User.create({
        name: "Shoaib Ramim",
        email: "shoaib@quickhire.test",
        passwordHash: await hash("password_changed_after_seeding"),
        role: "employer",
        company: "QuickHire Labs",
        companyLogo: "quickhire",
      }),
      User.create({
        name: "Maria Silva",
        email: "maria@nomad.test",
        passwordHash: await hash("password_changed_after_seeding"),
        role: "employer",
        company: "Nomad",
        companyLogo: "nomad",
      ...
      User.create({
        name: "Lucas Oliveira",
        email: "lucas@terraform.test",
        passwordHash: await hash("password_changed_after_seeding"),
        role: "employer",
        company: "Terraform",
        companyLogo: "terraform",
      }),
    ]);
  ...
  const seekerSeed = [
    {
      ...
      resumeLink: "https://example.com/alice",
    },
    {
      name: "Carlos Mendez",
      email: "carlos@example.com",
      resumeLink: "https://example.com/carlos",
    },
    {
      name: "Priya Singh",
      email: "priya.s@example.com",
      resumeLink: "https://example.com/priya",
    },
    {
      name: "Liam O'Brien",
      email: "liam@example.com",
      resumeLink: "https://example.com/liam",
    },
    {
      name: "Yuki Tanaka",
      email: "yuki@example.com",
      resumeLink: "https://example.com/yuki",
    },
    {
      name: "Sofia Adams",
      email: "sofia@example.com",
      resumeLink: "https://example.com/sofia",
    },
    {
      name: "Ethan Brooks",
      email: "ethan@example.com",
      resumeLink: "https://example.com/ethan",
    },
    {
      name: "Mia Chen",
      email: "mia@example.com",
      resumeLink: "https://example.com/mia",
    },
    {
      name: "Ravi Sharma",
      email: "ravi@example.com",
      resumeLink: "https://example.com/ravi",
    },
    {
      name: "Ifeoma Okafor",
      email: "ifeoma@example.com",
      resumeLink: "https://example.com/ifeoma",
    },
    {
      name: "Ben Howarth",
      email: "ben@example.com",
      resumeLink: "https://example.com/ben",
    },
    {
      name: "Nadia Volkov",
      email: "nadia@example.com",
      resumeLink: "https://example.com/nadia",
    },
  ];

  const seekerPasswordHash = await hash("password_changed_after_seeding");
  const jobSeekers = await User.insertMany(
    seekerSeed.map((seeker) => ({
      name: seeker.name,
      email: seeker.email,
  ...
  const seekerByEmail = new Map(
    jobSeekers.map((seeker) => [seeker.email, seeker]),
  );
  const getSeekerId = (email: string) => {
    const seeker = seekerByEmail.get(email);
    if (!seeker) throw new Error(`Missing job seeker for ${email}`);
    return seeker._id;
  };
  console.log(`✔ Seeded ${jobSeekers.length} job seeker users`);
  ...
  console.log(
    `✔ Seeded ${insertedJobs.length} jobs (${jobsData.filter((j) => j.featured).length} featured)`,
  );
  ...
  const appData = [
    {
      ...
      resumeLink: "https://example.com/alice",
      coverNote:
        "Big fan of Dropbox! Excited to bring my 6 years of brand experience.",
      status: "Shortlisted",
    },
    {
      job: insertedJobs[1],
      ...
      resumeLink: "https://example.com/carlos",
      coverNote:
        "I've been using Figma daily for 4 years and want to help shape its future.",
      status: "Reviewed",
    },
    {
      job: insertedJobs[5],
      ...
      resumeLink: "https://example.com/priya",
      coverNote:
        "Revolut's mission to disrupt banking aligns perfectly with my background.",
      status: "Pending",
    },
    {
      job: insertedJobs[8],
      ...
      resumeLink: "https://example.com/liam",
      coverNote:
        "I've grown lifecycle email revenue by 40% at my current role.",
      status: "Shortlisted",
    },
    {
      job: insertedJobs[15],
      ...
      resumeLink: "https://example.com/yuki",
      coverNote:
        "Experienced full-stack dev looking to make an impact at a growing startup.",
      status: "Reviewed",
    },
    {
      job: insertedJobs[16],
      ...
      resumeLink: "https://example.com/sofia",
      coverNote:
        "Stripe's engineering culture is exactly what I've been looking for.",
      status: "Shortlisted",
    },
    {
      job: insertedJobs[19],
      ...
      resumeLink: "https://example.com/ethan",
      coverNote:
        "3 years of DevOps at scale — happy to demo my Terraform modules!",
      status: "Pending",
    },
    {
      job: insertedJobs[22],
      ...
      email: "mia@example.com",
      resumeLink: "https://example.com/mia",
      coverNote: "I closed $2M in partnership deals last year across APAC.",
      status: "Reviewed",
    },
    {
      job: insertedJobs[0],
      ...
      email: "ravi@example.com",
      resumeLink: "https://example.com/ravi",
      coverNote: "Passionate about building brand systems that scale.",
      status: "Reviewed",
    },
    {
      job: insertedJobs[12],
      ...
      email: "ifeoma@example.com",
      resumeLink: "https://example.com/ifeoma",
      coverNote: "CFA Level 3 candidate with 3 years at Goldman Sachs.",
      status: "Shortlisted",
    },
    {
      job: insertedJobs[15],
      ...
      resumeLink: "https://example.com/ben",
      coverNote:
        "Love the QuickHire product — built something similar at a previous role.",
      status: "Pending",
    },
    {
      job: insertedJobs[20],
      ...
      email: "nadia@example.com",
      resumeLink: "https://example.com/nadia",
      coverNote: "Former Tesla intern with a PhD in computer vision.",
      status: "Reviewed",
    },
  ] as const;
  ...
  const insertedApplications = await Application.insertMany(
    appData.map((a) => ({
      applicantId: getSeekerId(a.email),
      jobId: a.job._id,
      name: a.name,
      email: a.email,
  ...
  await Promise.all(
    appData.map((a) =>
      Job.findByIdAndUpdate(a.job._id, { $inc: { applicantCount: 1 } }),
    ),
  );
  ...
  const jobById = new Map(insertedJobs.map((job) => [String(job._id), job]));
  ...
  async function seedConversation(
    application: (typeof insertedApplications)[number],
    messageSeed: SeedMessage[],
  ) {
    const job = jobById.get(String(application.jobId));
    if (!job) {
      throw new Error(`Missing job for application ${application._id}`);
    }
  ...
  const firstApp = insertedApplications[0];
  const firstJob = jobById.get(String(firstApp.jobId))!;
  const firstEmployerId = firstJob.postedBy as mongoose.Types.ObjectId;
  const firstSeekerId = firstApp.applicantId as mongoose.Types.ObjectId;

  const secondApp = insertedApplications[4];
  const secondJob = jobById.get(String(secondApp.jobId))!;
  const secondEmployerId = secondJob.postedBy as mongoose.Types.ObjectId;
  const secondSeekerId = secondApp.applicantId as mongoose.Types.ObjectId;

  const thirdApp = insertedApplications[6];
  const thirdJob = jobById.get(String(thirdApp.jobId))!;
  const thirdEmployerId = thirdJob.postedBy as mongoose.Types.ObjectId;
  const thirdSeekerId = thirdApp.applicantId as mongoose.Types.ObjectId;

  await Promise.all([
    seedConversation(firstApp, [
      {
        senderId: firstEmployerId,
        recipientId: firstSeekerId,
        body: "Thanks for applying! Would you be open to a quick intro call this week?",
        createdAt: minutesAgo(240),
        unread: true,
      },
      {
        senderId: firstSeekerId,
        recipientId: firstEmployerId,
        body: "Absolutely. I'm available Wednesday or Thursday afternoon.",
      ...
      },
      {
        senderId: firstEmployerId,
        recipientId: firstSeekerId,
        body: "Great, I'll send a calendar invite for Thursday at 2 PM.",
        createdAt: minutesAgo(120),
        unread: false,
        editedAt: minutesAgo(110),
      },
    ]),
    seedConversation(secondApp, [
      {
        senderId: secondEmployerId,
        recipientId: secondSeekerId,
        body: "Hi Yuki, thanks for applying. Could you share a few recent backend projects?",
        createdAt: minutesAgo(90),
        unread: true,
      },
      {
        senderId: secondSeekerId,
        recipientId: secondEmployerId,
        body: "Sure! I just emailed two project links and can walk through them anytime.",
        createdAt: minutesAgo(60),
        unread: true,
      },
    ]),
    seedConversation(thirdApp, [
      {
        senderId: thirdEmployerId,
        recipientId: thirdSeekerId,
        body: "Thanks for your application. Do you have availability for a DevOps interview next week?",
  ...
  console.log("✔ Seeded 3 conversations and 6 messages");
  ...
  await ScheduleEvent.insertMany([
    {
      ownerId: shoaib._id,
      title: "Interview: Alice Nguyen — Lead UX Designer",
      time: "10:00 AM",
      date: "Mar 3, 2026",
      type: "Interview",
      withPerson: "Alice Nguyen",
    },
    {
      ownerId: shoaib._id,
      title: "Technical Screen: Yuki Tanaka",
      time: "2:00 PM",
      date: "Mar 3, 2026",
      type: "Interview",
      withPerson: "Yuki Tanaka",
    },
    {
      ownerId: shoaib._id,
    ...
    {
      ownerId: shoaib._id,
      title: "Interview: Ben Howarth — Full Stack Dev",
      time: "11:00 AM",
      date: "Mar 5, 2026",
      type: "Interview",
      withPerson: "Ben Howarth",
    },
    {
      ownerId: shoaib._id,
      title: "Resume Review — Finance Applications",
      time: "3:00 PM",
      date: "Mar 5, 2026",
      type: "Review",
    },
