...
export default function LatestJobsSection({ jobs }: { jobs: LatestJob[] }) {
  return (
    <section
      className="bg-hero-bg pt-14 sm:pt-24 pb-10 sm:pb-16 lg:pt-20 relative overflow-hidden"
      aria-label="Latest jobs open"
    >
      ...
      <div
        className="absolute -top-10 -right-16 w-80 h-96 opacity-40 pointer-events-none"
        aria-hidden="true"
      >
        <GeometricDecoration />
      </div>
      ...
      <div
        className="absolute -bottom-10 -left-16 w-72 h-80 opacity-25 pointer-events-none rotate-180"
        aria-hidden="true"
      >
        <GeometricDecoration />
      </div>

      <div className="relative z-10 max-w-screen-3xl mx-auto px-4 sm:px-6 lg:px-16">
        {/* Section header */}
        <div className="flex flex-wrap items-center justify-between gap-3 mb-8 sm:mb-10">
          <h2 className="text-2xl sm:text-3xl font-extrabold text-heading-dark">
            Latest <span className="text-brand-indigo">Jobs Open</span>
          </h2>
