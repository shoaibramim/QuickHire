    ...
    <header className="h-16 bg-white border-b border-gray-100 flex items-center px-6 gap-4 sticky top-0 z-30">
      ...
      <div className="relative">
        ...
        >
          ...
          {/* Unread dot */}
          <span className="absolute top-1.5 right-1.5 w-2 h-2 rounded-full bg-brand-indigo" aria-hidden="true" />
        </button>
        ...
        {notifOpen && (
          <div className="absolute right-0 top-full mt-2 w-72 bg-white rounded-xl shadow-lg border border-gray-100 p-4 z-50 animate-[fadeSlideUp_0.15s_ease-out]">
            <p className="text-sm font-semibold text-heading-dark mb-3">Notifications</p>
            <div className="space-y-3">
              {["New applicant for Brand Designer", "Interview scheduled for tomorrow", "Your job listing expires in 3 days"].map((n, i) => (
