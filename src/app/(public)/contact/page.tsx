        ...
        <div className="max-w-screen-3xl mx-auto px-4 sm:px-6 lg:px-16 py-12 sm:py-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div className="space-y-8">
              <div>
                ...
                <p className="text-subtitle text-sm leading-relaxed">
                  Whether you&apos;re a job seeker needing access, an employer
                  with a billing question, or just want to say hello - our team
                ...
                {[
                  {
                    icon: "email",
                    label: "Email",
                    value: "support@quickhirebd.vercel.app",
                  ...
                  <div key={label} className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-xs font-semibold uppercase tracking-wider text-subtitle mb-0.5">
                        {label}
                      </p>
                      {href ? (
                        <a
                          href={href}
                          className="text-sm font-medium text-heading-dark hover:text-brand-indigo transition-colors"
                        >
                          {value}
                        </a>
                      ) : (
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm">
              <h2 className="text-lg font-bold text-heading-dark mb-6">
                Send a Message
              </h2>
              <ContactForm />
            </div>
